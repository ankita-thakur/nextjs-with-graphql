...
const SettingBoxes = () => {
 ...
 ac suscipit diam sem a felis. Cras sapien ex, blandit eu dui et suscipit gravida nunc. Sed sed est quis dui."
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    className="flex justify-center rounded-[7px] bg-lime-600 px-6 py-[7px] font-medium text-gray-2 hover:bg-opacity-90"
                    type="submit"
                  >
                    Save
                  </button>
            ...
            <div className="p-7">
              <form>
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    className="flex items-center justify-center rounded-[7px] bg-lime-600 px-6 py-[7px] font-medium text-gray-2 hover:bg-opacity-90"
                    type="submit"
                  >
                    Save
                  </button>
