          ...
          <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
            ...
            <form action="#">
              <div className="p-6.5">
                ...
                <button className="flex w-full justify-center rounded-[7px] bg-lime-600 p-[13px] font-medium text-white hover:bg-opacity-90">
                  Send Message
                </button>
              </div>
            </form>
          ...
          <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
            ...
            <form action="#">
              <div className="p-6.5">
                ...
                <button className="flex w-full justify-center rounded-[7px]  p-[13px] font-medium text-white hover:bg-opacity-90">
                  Sign Up
                </button>
              </div>
            </form>
